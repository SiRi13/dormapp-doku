...
(Abb. \ref{sql:usersTest}) angelegt.
...
Die Skripte befinden sich in vollem Umfang noch als Anhang an diese Dokumentation.
\pagebreak
...
\verb!startActivity()! aufgerufen, welches die \verb!LoginActivity.java! startet (siehe Abbildung
...
\begin{lstlisting}[float=h, caption=Auszug aus der MainActivity.java, captionpos=below, label=java:MainActivityProto3, language=java, escapechar=|]
[|\ldots{}|]        
...
\begin{lstlisting}[float=h, caption=Auszug aus SyncRemoteDatabase.java, captionpos=below, label=java:SyncRemoteDBProto, language=java, escapechar=|]
[|\ldots{}|]        
@Override
...
\begin{lstlisting}[float=h, caption=Auszug aus UserFunctions.java, captionpos=below, label=java:UsrFuncsProto, language=java, escapechar=|]
[|\ldots{}|]        
...
\begin{lstlisting}[float=h, caption=Auszug aus JSONParser.java, captionpos=below, label=java:JSONParserProto, language=java, escapechar=|]
...
\begin{lstlisting}[float=h, caption=Auszug aus der DatabaseHandler.java, captionpos=below, label=java:DBHandlerProto, language=java, escapechar=|]
[|\ldots{}|]        
