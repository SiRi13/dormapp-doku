...
Ist der Benutzer eingeloggt, wird das PHP Script nicht gestoppt, sondern weiter verarbeitet. Mit einem \textit{require\textunderscore oce 'db\textunderscore inc.php} wird die Datei db\textunderscore inc.php eingebunden und ausgeführt. Das passiert aber nur, wenn die Datei nicht schon vorher durch ein anderes Script eingebunden wurde.
...
Im Anschluss können die über die POST bzw. GET von der HTML Seite übergebenen Parameter abgefragt und zwischengespeichert werden. In dem Beispiel wird mit einer if-Anfrage geprüft, ob ein Parameter "einkaufsliste\textunderscore id" geliefert wurde, falls dies der Fall ist, wird der Inhalt der Variablen lokal zwischengespeichert.
